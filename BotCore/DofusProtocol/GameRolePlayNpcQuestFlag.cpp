...
void GameRolePlayNpcQuestFlag::deserialize(ICustomDataInput &input) {
    this->deserializeAs_GameRolePlayNpcQuestFlag(input);
}

void GameRolePlayNpcQuestFlag::deserializeAs_GameRolePlayNpcQuestFlag(ICustomDataInput &input) {
...
void GameRolePlayNpcQuestFlag::_questsToValidIdFunc(ICustomDataInput &input) {
    unsigned int _val = input.readVarUhShort();

    this->questsToValidId.push_back(_val);
}

void GameRolePlayNpcQuestFlag::_questsToStartIdFunc(ICustomDataInput &input) {
    unsigned int _val = input.readVarUhShort();
