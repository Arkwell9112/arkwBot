...
void ActorRestrictionsInformations::deserialize(ICustomDataInput &input) {
    this->deserializeAs_ActorRestrictionsInformations(input);
}

void ActorRestrictionsInformations::deserializeAs_ActorRestrictionsInformations(ICustomDataInput &input) {
    this->deserializeByteBoxes(input);
}

void ActorRestrictionsInformations::deserializeByteBoxes(ICustomDataInput &input) {
    ...
    unsigned int _box1 = input.readByte();
    ...
    unsigned int _box2 = input.readByte();
